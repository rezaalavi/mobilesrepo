...
module Mobiles #:nodoc: all 
 ...
 module Repository
   class Samsung_sgh_u800_ver1 < Generic_netfront_ver3_4
def self.user_agent
 "SAMSUNG-SGH-U800/1.0 SHP/VPP/R5 NetFront/3.4 SMM-MMS/1.2.0 profile/MIDP-2.0 configuration/CLDC-1.1".gsub(/\a/, '\\')
end
