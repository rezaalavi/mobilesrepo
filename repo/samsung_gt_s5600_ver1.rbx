...
module Mobiles #:nodoc: all 
 ...
 module Repository
   class Samsung_gt_s5600_ver1 < Generic_dolfin
def self.user_agent
 "SAMSUNG-GT-S5600-Vodafone/S5600BUID1 SHP/VPP/R5 Jasmine/0.8 Qtv5.3 SMM-MMS/1.2.0 profile/MIDP-2.1 configuration/CLDC-1.1".gsub(/\a/, '\\')
end
  def pointing_method
  "touchscreen"
end
