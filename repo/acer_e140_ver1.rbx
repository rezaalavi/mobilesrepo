...
module Mobiles #:nodoc: all 
 ...
 module Repository
   class Acer_e140_ver1 < Generic_android_ver2_2
def self.user_agent
 "Mozilla/5.0 (Linux;  U; Android 2.2; en-us; E140 Build/Froyo) AppleWebKit/533.1+ (KHTML, like  Gecko) Version/4.0 Mobile Safari/533.1.1ACER_E140/1.0".gsub(/\a/, '\\')
end
  def has_qwerty_keyboard?
  false
end
def uaprof
  "http://support.acer.com/UAprofile/Acer_E140_profile.xml"
end
def model_name
  "Acer E140"
end
