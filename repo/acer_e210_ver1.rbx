...
module Mobiles #:nodoc: all 
 ...
 module Repository
   class Acer_e210_ver1 < Generic_android_ver2_2
def self.user_agent
 "Mozilla/5.0 (Linux;  U; Android 2.2; en-us; E210Build/Froyo) AppleWebKit/533.1+ (KHTML, like  Gecko) Version/4.0 Mobile Safari/533.1.1ACER_E210/1.0".gsub(/\a/, '\\')
end
  def uaprof
  "http://support.acer.com/UAprofile/Acer_E210_profile.xml"
end
def model_name
  "Acer E210"
end
