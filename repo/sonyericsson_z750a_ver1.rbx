...
module Mobiles #:nodoc: all 
 ...
 module Repository
   class Sonyericsson_z750a_ver1 < Generic_sonyericsson_netfront_ver3_4
def self.user_agent
 "SonyEricssonZ750a/R1BA Browser/NetFront/3.4 Profile/MIDP-2.1 Configuration/CLDC-1.1".gsub(/\a/, '\\')
end
  def uaprof
