...
module Mobiles #:nodoc: all 
 ...
 module Repository
   class Pantech_c520_ver1 < Lg_generic_obigo_q5
def self.user_agent
 "PANTECH-C520/R01 Browser/Obigo/Q05A Profile/MIDP-2.0 Configuration/CLDC-1.1".gsub(/\a/, '\\')
end
  def mobile_browser
  "Teleca-Obigo"
end
def uaprof
  "http://www.pantech.com/Uaprof/Gsm/C520.xml"
end
def model_name
  "C520"
end
