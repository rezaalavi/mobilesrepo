...
eval_file 'repository/nokia_5700_ver1.rbx'
module Mobiles #:nodoc: all 

 module Repository
   class Nokia_5700_ver1_sub_safari < Nokia_5700_ver1
def self.user_agent
 "Mozilla/5.0 (SymbianOS/9.2; U; Series60/3.1 Nokia5700/3.27; Profile/MIDP-2.0 Configuration/CLDC-1.1 ) AppleWebKit/413 (KHTML, like Gecko) Safari/413".gsub(/\a/, '\\')
end
  def mobile_browser
  "Safari"
end
